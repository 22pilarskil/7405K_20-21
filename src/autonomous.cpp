...
void autonomous()
{
    ...
    Robot::move_to({-1870, 2380, 334}, {1, 1, 1}, {1, 1, 1}); //turning
    Robot::intake({127, 127, 127, -90}); //pooping
...
//    Robot::intake({0, 0, 0, 0});
//    Robot::move_to({710, 5760, 268}); //tower 5 very inconsistent
...
//   Robot::move_to({4190, 2720, 358}); //tower 7
